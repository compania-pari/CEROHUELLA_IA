...
variable "container_apps_subnet_name" {
  ...
  type        = string
  default     = "snet-containerapps-dev"
}
...
variable "container_apps_environment_name" {
  ...
  type        = string
  default     = "cae-cerohuella-dev"
}

variable "managed_identity_name" {
  description = "Managed identity name."
  type        = string
  default     = "id-cerohuella-api-dev"
}

variable "container_app_name" {
  description = "Container App name."
  type        = string
  default     = "ca-cerohuella-api-dev"
}
...
variable "postgresql_private_dns_zone_name" {
  ...
  type        = string
  default     = "pdz-cerohuella-dev.postgres.database.azure.com"
}
