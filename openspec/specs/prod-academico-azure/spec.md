...
Define el comportamiento esperado del ambiente PROD academico de Cero Huella IA en Azure: minimo en costos, manual para despliegue productivo, reconstruible con Terraform y con observabilidad propia.
